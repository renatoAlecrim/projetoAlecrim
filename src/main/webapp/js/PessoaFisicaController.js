                ...
                $timeout(function () {
                    ...
                    $http.get(busca)
                            .success(function (data) {
                                ...
                                $scope.juridica.inscricaoEstadual = (data.inscricaoEstadual != "") ? data.inscricaoEstadual : " ";
                                $scope.juridica.inscricaoSuframa = (data.inscricaoSuframa != "") ? data.inscricaoSuframa : " ";
                                $scope.juridica.email = (data.email != null && data.email.email != "") ? data.email.email : " ";
                    ...
                    $timeout(function () {
                        ...
                        $http.get(busca)
                                .success(function (data) {
                                    ...
                                    $scope.fisica.email.email = (data.email != null && data.email.email != "") ? data.email.email : " ";
