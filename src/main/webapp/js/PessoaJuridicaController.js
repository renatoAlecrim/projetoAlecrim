                ...
                $timeout(function () {
                    $http.get("/pessoa/juridica/obj/" + $routeParams.id)
                        ...
                        console.log(data);
                                ...
                                $scope.juridica.inscricaoEstadual = (data.inscricaoEstadual != null) ? data.inscricaoEstadual : "";
                                $scope.juridica.inscricaoSuframa = (data.inscricaoSuframa != null) ? data.inscricaoSuframa : "";
