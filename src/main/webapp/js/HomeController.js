        ...
        var tocalendar = function () {
            ...
            if (this.events !== undefined) {
                ...
                for (var o = 0; o < ev.length; o++) {
                    $(".specific-day-scheme").append('<div class="specific-day-scheme-event border-'+ ev[o]['tipo'] +'"><p>' + ev[o]['name'] + '</p><p data-role="dur">' + ev[o]['timestart'] + '</p></div>'); //<p data-role="loc">' + ev[o]['datestart'] + ev[o]['dateend'] + '</p></div>'); // Monta os eventos do dia clicado.
                }
            }
