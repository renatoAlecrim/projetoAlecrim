...
public class JuridicaService extends ServiceBase<CriarPessoaJuridica, Long, JuridicaRepository> {
    ...
    final String SQLConsultaJuridica = "SELECT p.idpessoa, p.nome, p.email, p.tipo_pessoa, pj.cnpj as documento, pj.inscricaoEstadual,"
            + "pj.inscricaoSuframa, p.telefone,"
