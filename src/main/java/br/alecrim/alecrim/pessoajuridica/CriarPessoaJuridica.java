...
public class CriarPessoaJuridica {
    ...
    public CriarPessoaJuridica(Long idpessoa, String nome, Telefone telefone, Telefone telefonesecundario, Email email, String logradouro, String numero, String bairro, String complemento, String cep, Long codigoibge, Long codigouf, TipoPessoa tipo, Cnpj cnpj, String inscricaoEstadual, String inscricaoSuframa) {
