...
import br.alecrim.alecrim.itemacesso.ItemAcessoUsuarioInMemory;
import br.alecrim.alecrim.consultapersonalizada.QueryPersonalizada;
import br.alecrim.alecrim.usuario.Status;
import br.alecrim.alecrim.usuario.Usuario;
import br.alecrim.alecrim.usuario.UsuarioRepository;
    ...
    public ItemAcessoUsuarioInMemory getItensDeAcessoUsuarioLogado() {
        ...
        if (sessaoUsuario != null && sessaoUsuario.getUsuario() != null) {
            String SQL  = "  SELECT ia.iditemacesso, "
                        ...
                        + "         ia.icone, "
                        + "         ia.superior_id "
                        + " ORDER BY ia.superior_id NULLS FIRST ";
